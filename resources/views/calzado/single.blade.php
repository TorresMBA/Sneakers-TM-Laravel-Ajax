@extends('layouts.app')
@section('title', 'GG')
@section('ruta', 'Nombre del Calzado')
			...
			<div class="col-md-4 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="{{ asset("assests/$theme/images/d2.jpg") }}">
								<div class="thumb-image"> <img src="{{ asset("assests/$theme/images/d2.jpg") }}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="{{ asset("assests/$theme/images/d1.jpg") }}">
								<div class="thumb-image"> <img src="{{ asset("assests/$theme/images/d1.jpg") }}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
							<li data-thumb="{{ asset("assests/$theme/images/d3.jpg") }}">
								<div class="thumb-image"> <img src="{{ asset("assests/$theme/images/d3.jpg") }}" data-imagezoom="true" class="img-responsive"> </div>
							</li>
						</ul>
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="{{ asset("assests/$theme/images/t1.jpg") }}" alt=" " class="img-responsive">
										</div>
			...
			<div class="new_arrivals">
				...
				<div class="col-md-3 product-men women_two">
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							<div class="men-thumb-item">
								<img src="{{ asset("assests/$theme/images/s7.jpg") }}" alt="">
								<div class="men-cart-pro">
									<div class="inner-men-cart-pro">
										<a href="single.html" class="link-product-add-cart">Quick View</a>
									</div>
				...
				<div class="col-md-3 product-men women_two">
					<div class="product-shoe-info shoe">
						<div class="men-pro-item">
							<div class="men-thumb-item">
								<img src="{{ asset("assests/$theme/images/s8.jpg") }}" alt="">
								<div class="men-cart-pro">
									<div class="inner-men-cart-pro">
										<a href="single.html" class="link-product-add-cart">Quick View</a>
									</div>
...
@section('js')
	...
	<!-- single -->
		<script src="{{ asset("assests/$theme/js/imagezoom.js") }}"></script>
	<!-- single -->

	<!-- script for responsive tabs -->
		<script src="{{ asset("assests/$theme/js/easy-responsive-tabs.js") }}"></script>
		<script>
    ...
    <!-- FlexSlider -->
		<script src="{{ asset("assests/$theme/js/jquery.flexslider.js") }}"></script>
		<script>
